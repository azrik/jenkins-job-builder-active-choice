...
setup(
    ...
    entry_points={
        'jenkins_jobs.parameters': [
            'uno-choice = jenkins_jobs_active_choice.active_choice:uno_choice_parameter',
            'uno-cascade-choice = jenkins_jobs_active_choice.active_choice:uno_cascade_choice_parameter']},
